      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          <h1 className={`${tourney.className} text-4xl md:text-6xl font-bold text-white mb-6`}>
            Documentation <span className="text-[#00FFC2]">Coming Soon</span>
          </h1>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus:border-[#00FFC2] focus:outline-none"
            />
            <button className="bg-[#00FFC2] hover:bg-[#00FFC2]/80 text-[#0A0E17] px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap">
              Notify Me
            </button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a
              href="mailto:support@cyclespace.exchange"
              className="text-[#00FFC2] hover:text-[#00FFC2]/80 transition-colors"
            >
              support@cyclespace.exchange
            </a>
