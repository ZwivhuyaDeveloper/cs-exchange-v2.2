      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-[#00FFC2]" color='#00FFC2' />
                  <span className="text-gray-400">Complete all foundation courses</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-[#00FFC2]" color='#00FFC2' />
                  <span className="text-gray-400">Pass comprehensive final exam</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-[#00FFC2]" color='#00FFC2' />
                  <span className="text-gray-400">Complete practical trading project</span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="h-5 w-5 text-[#00FFC2]" color='#00FFC2' />
                  <span className="text-gray-400">Maintain continuing education credits</span>
                </div>
              </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="bg-gradient-to-br from-gray-950 to-gray-700 rounded-2xl p-8 border-2 border-[#00FFC2]/30 shadow-2xl">
              {/* Certificate Header */}
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-400">has successfully completed the</p>
                <div className="text-xl font-semibold text-white">Cyclespace Certified Trader Program</div>
                <p className="text-gray-400">and demonstrated proficiency in cryptocurrency trading</p>
              </div>
        ...
        >
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 max-w-3xl mx-auto">
            <blockquote className="text-xl text-gray-400 italic mb-6">
              &ldquo;The Cyclespace certification opened doors I never thought possible. Within 3 months of earning my certificate, I landed a position at a top crypto hedge fund.&rdquo;
            </blockquote>
