  ...
  return (
    <div className='flex flex-col h-fit '>
        ...
        <div className='p-3 flex flex-col gap-2 mt-0 pt-0 h-fit'>
          {data.map((post, idx) => (
            <Card key={idx} className='p-3 shadow-none bg-zinc-100 border-none flex flex-row h-fit '>
              <Image
            ...
            <h3 className="text-sm w-full flex flex-row h-fit text-start mt-0 mb-3 text-black font-semibold">
