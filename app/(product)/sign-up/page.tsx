        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
              Join <span className="text-blue-600 dark:text-blue-400">CS Exchange</span> today
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Create your account to unlock powerful trading tools, market insights, and portfolio management features.
            </p>
            <div className="space-y-4 pt-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-600 dark:text-gray-300">Get access to premium research and signals</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                  <svg className="h-4 w-4 text-blue-600 dark:text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-600 dark:text-gray-300">Track your favorite assets and portfolios</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="flex-shrink-0 h-6 w-6 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center">
                  <svg className="h-4 w-4 text-blue-600 dark:text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-gray-600 dark:text-gray-300">Stay updated with real-time market data</span>
              </div>
            </div>
          </div>
